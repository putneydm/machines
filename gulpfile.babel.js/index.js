...
// combined tasks
exports.default = series(parallel(cleanCSS, cleanJS, cleanPages), bower, svg, parallel(css, cssInline), parallel(concatJs), cachebustScripts, parallel(includes, layouts, pages, collections))

exports.rebuild = series(parallel(cleanCSS, cleanJS, cleanPages), parallel(css, cssInline), parallel(concatJs), cachebustScripts, parallel(includes, layouts, pages, collections))
